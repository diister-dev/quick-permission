 ...
 * @module permission
 */
import type { ExtractSchemasFromRules, Hierarchy, Permission, PermissionSchemas } from "../types/common.ts";
import type { Rule } from "../types/rule.ts";
import type { Schema } from "../types/schema.ts";

/**
 * Creates a permission object with schemas, rules, and optional children
 * 
